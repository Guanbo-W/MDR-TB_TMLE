...
coverage<-as.numeric(as.logical(0.742>ci.san.a1[1])&0.742<ci.san.a1[2])
...
coverage.w<-as.numeric(as.logical(0.742>ci.san.a1.w[1])&0.742<ci.san.a1.w[2])
